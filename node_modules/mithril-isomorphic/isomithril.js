...
module.exports = function (config) {
	...
	return function (req, res, next) {
		...
		var a = routeByValue(routes, req.url);
		console.log('rbv', a, routeParams);
		Mithril.module(mock.window.document.body, IsoModules[a || routes[def]]);
		...
		FS.read(path.join(localRoot, page)).then(function (data) {
			...
			console.log('var cellCache = ', JSON.stringify(Mithril.$cellCache, function (key, value) {
				if (key == 'nodes') return null;
				return value;
			}));
			console.log('var cell = ', JSON.stringify(Mithril.$cell, function (key, value) {
				...
				if (key == 'config'  && value == Mithril.route) return 'm.route()';
				return value;
			}));
